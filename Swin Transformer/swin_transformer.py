# --------------------------------------------------------------------------
# Swin Transformer in PaddlePaddle
...
class SwinTransformer(nn.Layer):
    ...
    def _init_weights(self, m):
        normal_ = nn.initializer.Normal(std=.02)
        constant_0 = nn.initializer.Constant(value=0.0)
        constant_1 = nn.initializer.Constant(value=1.0)
